...
import { MOCK_REVENUE_CHART, MOCK_TRANSACTION_CHART, MOCK_PLATFORM_STATS } from "@/constants";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent><div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie data={MOCK_PLATFORM_STATS} cx="50%" cy="50%" innerRadius={60} outerRadius={90} paddingAngle={4} dataKey="value" nameKey="name">
