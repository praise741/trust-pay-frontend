      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <Card><CardContent className="p-6 text-center">
            ...
            <div className="flex items-center justify-center gap-1 mt-2"><Badge className="gap-1"><ShieldCheck className="h-3 w-3" /> Verified Seller</Badge></div>
            <div className="mt-4 p-4 rounded-xl bg-primary/5 border border-primary/10"><p className="text-sm text-muted-foreground mb-1">Trust Score</p><p className="text-3xl font-bold text-primary">{user.trustScore}</p><Progress value={user.trustScore} className="mt-2 h-2" /></div>
          </CardContent></Card>
        </motion.div>
